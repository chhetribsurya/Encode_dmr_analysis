...
chromHMM_file = os.path.expanduser("~/Dropbox/local_miscellaneous_data/test_data/chrom_impute_chromHMM_data/E008_25_imputed12marks_dense.bed")  
background_dmr_file = os.path.expanduser("~/Dropbox/local_miscellaneous_data/test_data/metilene_dmr_data/merged_processed_DMR/analyse_DMR_output_data/merged_processed_DMR/hypo_H9_hESC_background_dmr.bed")

##
dmr_file = os.path.expanduser("~/Dropbox/local_miscellaneous_data/test_data/metilene_dmr_data/merged_processed_DMR/analyse_DMR_output_data/merged_processed_DMR/human_ES_cell_final_dmrs.bed")
dmr_file1=os.path.expanduser("~/Dropbox/local_miscellaneous_data/test_data/ENCODE_poster/parsed_data_R_output/hypo_dmrs.txt")
dmr_file2=os.path.expanduser("~/Dropbox/local_miscellaneous_data/test_data/ENCODE_poster/parsed_data_R_output/hypo_dmrs.txt")
##
...
JSON_dict_file = os.path.expanduser("~/Dropbox/local_miscellaneous_data/test_data/ENCODE_poster/parsed_data_R_output/ENCODE_chromHMM_JSON_1.txt")

##
TF_fishers_enrichment = os.path.expanduser("~/Dropbox/local_miscellaneous_data/test_data/ENCODE_poster/parsed_data_R_output/hypo_chromHMM_fishers_enrichment_result.txt")
##

out_file = os.path.expanduser("~/Dropbox/local_miscellaneous_data/test_data/ENCODE_poster/parsed_data_R_output/hypo_significant_dmr_overlaps_with_chromHMM.bed")
out_file_2 = os.path.expanduser("~/Dropbox/local_miscellaneous_data/test_data/ENCODE_poster/parsed_data_R_output/hypo_background_dmr_overlaps_with_chromHMM.bed")
...
#to the same file:
directory = os.path.expanduser("~/Dropbox/local_miscellaneous_data/test_data/ENCODE_poster/parsed_data_R_output/sig_DMR_chromHMM")
...
##Following piece of code prevents the append file mode to append the outputs to be appended
#to the same file:
directory = os.path.expanduser("~/Dropbox/local_miscellaneous_data/test_data/ENCODE_poster/parsed_data_R_output/backg_DMR_chromHMM")
if not os.path.exists(directory):
    os.makedirs(directory)
    #os.rmdir(prior_dir)
    #shutil.rmtree()
...
with open(TF_fishers_enrichment, "w") as out_file:	
	...
	Significant_hits = len(custom_overlap_list) # Original DMR hits or initial DMR counts
	Background_hits = len(custom_overlap_list_2) # Original BG hits or initial BG DMR counts
